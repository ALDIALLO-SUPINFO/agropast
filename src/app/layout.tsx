...
export const metadata: Metadata = {
  title: 'Agro-Past Mauritanie',
  description: 'Développement Durable de l\'Agriculture et de l\'Élevage en Mauritanie',
}
  ...
  return (
    <html lang="fr">
      <body className={inter.className}>
        ...
        {/* Footer moderne avec dégradé vert */}
        <footer className="bg-gradient-to-r from-green-800 to-green-900 text-white">
          <div className="container mx-auto px-6 py-12">
            ...
            <div className="mt-8 pt-8 border-t border-green-700/30 text-center text-green-100/60">
              <p>&copy; {new Date().getFullYear()} Agro-Past. Tous droits réservés.</p>
            </div>
          </div>
        </footer>
      </body>
